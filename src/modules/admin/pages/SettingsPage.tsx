    ...
    <div className="flex flex-col gap-6 p-4 lg:p-6">
          ...
          <div className="w-full">
            ...
            {expandedSection === 'general' && (
              ...
              style={{boxShadow:'0 4px 6px rgba(0, 0, 0, 0.5)'}}>
                <div className="flex justify-between items-center mb-4">
                  <h2 className={`text-xl font-bold ${sun ? 'text-white' : 'text-gray-900'}`}>General Settings</h2>
                  <button
                    onClick={() => toggleSection('general')}
            ...
            {expandedSection === 'lending' && (
              ...
              style={{boxShadow:'0 4px 6px rgba(0, 0, 0, 0.5)'}}>
                <div className="flex justify-between items-center mb-4">
                  <h2 className={`text-xl font-bold ${sun ? 'text-white' : 'text-gray-900'}`}>Lending Settings</h2>
                  <button
                    onClick={() => toggleSection('lending')}
                    className={`text-2xl hover:opacity-70 transition ${sun ? 'text-gray-300' : 'text-gray-500'}`}
                  >
            ...
            {expandedSection === 'notification' && (
              ...
              style={{boxShadow:'0 4px 6px rgba(0, 0, 0, 0.5)'}}>
                <div className="flex justify-between items-center mb-4">
                  <h2 className={`text-xl font-bold ${sun ? 'text-white' : 'text-gray-900'}`}>Notification Settings</h2>
                  <button
                    onClick={() => toggleSection('notification')}
                    className={`text-2xl hover:opacity-70 transition ${sun ? 'text-gray-300' : 'text-gray-500'}`}
                  >
            ...
            {!expandedSection && (
              <div className={`rounded-lg p-4 lg:p-6 text-center w-full lg:max-w-2xl ${sun ? 'bg-gray-800 text-gray-300' : 'bg-white text-gray-500'}`} 
              style={{boxShadow:'0 4px 6px rgba(0, 0, 0, 0.5)'}}>
